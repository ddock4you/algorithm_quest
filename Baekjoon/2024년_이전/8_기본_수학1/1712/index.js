// todo 제목: 손익분기점
// ! 문제: 월드전자는 노트북을 제조하고 판매하는 회사이다. 노트북 판매 대수에 상관없이 매년 임대료, 재산세, 보험료, 급여 등 A만원의 고정 비용이 들며,
...
const condition = (v) => v <= 2100000000;
const [A, B, C] = input;
// let count = 1;

// while (true) {
//     const pays = A + B * count;
//     const notebooks = C * count;
//     if (pays < notebooks) break;
//     if (!condition(count)) {
//         count = -1;
//         break;
//     }
...
const saleMargin = C - B;
const count = Math.floor(A / saleMargin) + 1;

console.log(saleMargin > 0 ? count : -1);
